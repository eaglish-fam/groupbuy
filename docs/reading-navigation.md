...
- The compact tab paints only 20px inside the article's 22px mobile gutter, with a transparent 44px-wide touch target. A chevron hints twice, never continuously. Tap/right swipe opens; close/left swipe/outside tap/Escape closes. Vertical scrolling stays native.
