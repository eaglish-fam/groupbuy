...
test('public blog candidate has clear sections, static article links, and no internal review language',()=>{
  ...
  const slugs=['atojet','wave-hummus','artisan-cb301','meroware','mitoy-rice-blocks','chulu-aomori-drinks','hereu-tag','playzu','kietla-kids-sunglasses','fushan-gifts','caesar-kenting','miamily','shoumaji','lange'];
